...
$(document).ready(function () {
  ...
  $("#nanoshowcase").nanogallery2({
    ...
    items: [
      ...
      { src: '/assets/img/showcase/cinema/4.png', ID: 13, albumID: 1 },
      { src: '/assets/img/showcase/cinema/5.png', ID: 14, albumID: 1 },
      { src: '/assets/img/showcase/cinema/6.png', ID: 15, albumID: 1 },
      { src: '/assets/img/showcase/cinema/7.png', ID: 16, albumID: 1 },
      // service
      { src: '/assets/img/showcase/service/1.png', title: 'Service', ID: 2, kind: 'album' },
      { src: '/assets/img/showcase/service/1.png', ID: 20, albumID: 2 },
      { src: '/assets/img/showcase/service/2.png', ID: 21, albumID: 2 },
      { src: '/assets/img/showcase/service/3.png', ID: 22, albumID: 2 },
      { src: '/assets/img/showcase/service/4.png', ID: 23, albumID: 2 },
      { src: '/assets/img/showcase/service/5.png', ID: 24, albumID: 2 },
      { src: '/assets/img/showcase/service/6.png', ID: 24, albumID: 2 },
      // store
      { src: '/assets/img/showcase/store/1.png', title: 'Store', ID: 3, kind: 'album' },
      { src: '/assets/img/showcase/store/1.png', ID: 30, albumID: 3 },
      { src: '/assets/img/showcase/store/2.png', ID: 31, albumID: 3 },
      { src: '/assets/img/showcase/store/3.png', ID: 32, albumID: 3 },
      { src: '/assets/img/showcase/store/4.png', ID: 33, albumID: 3 },
      { src: '/assets/img/showcase/store/5.png', ID: 34, albumID: 3 },
      { src: '/assets/img/showcase/store/6.png', ID: 35, albumID: 3 },
      { src: '/assets/img/showcase/store/7.png', ID: 36, albumID: 3 },
      { src: '/assets/img/showcase/store/8.png', ID: 37, albumID: 3 },
      { src: '/assets/img/showcase/store/9.png', ID: 38, albumID: 3 },
      { src: '/assets/img/showcase/store/10.png', ID: 39, albumID: 3 },
      { src: '/assets/img/showcase/store/11.png', ID: 301, albumID: 3 },
      // tours
      { src: '/assets/img/showcase/tours/1.png', title: 'Tours', ID: 4, kind: 'album' },
      { src: '/assets/img/showcase/tours/1.png', ID: 40, albumID: 4 },
      { src: '/assets/img/showcase/tours/2.png', ID: 41, albumID: 4 },
      { src: '/assets/img/showcase/tours/3.png', ID: 42, albumID: 4 }
    ]
  });
